...
- **W A S D** / strzałki — chodzenie, **Q / E** — obrót w poziomie, **Shift** — bieg, mysz — rozglądanie (kliknij, aby wejść)
- najechanie na obraz — karta ze szczegółami i estymacją (zł)
...
- `assets/data.js` — dane 164 obrazów (tytuły, wymiary, kategorie, estymacje PLN, status sprzedaży) wygenerowane z `Kosno - Obrazy/Kosno_katalog.html` i `_lista.txt`
